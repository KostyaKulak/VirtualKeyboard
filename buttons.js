...
let buttons = [
  ...
  new Button(3, 'CapsLock', {
    locale: {
      en: ['CapsLock', 'CapsLock'], ru: ['CapsLock', 'CapsLock']
    },
    special: {
      nonPrintable: true
    },
